/*
  ...
  - You are about to drop the column `ordem_total` on the `Item_Maquina` table. All the data in the column will be lost.
...
INSERT INTO "new_Item_Maquina" ("corte", "finalizado", "id_item_maquina", "itemId", "maquinaId", "ordem", "prazo", "prioridade") SELECT "corte", "finalizado", "id_item_maquina", "itemId", "maquinaId", "ordem", "prazo", "prioridade" FROM "Item_Maquina";
