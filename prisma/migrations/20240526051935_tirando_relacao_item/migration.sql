...
INSERT INTO "new_Chapa_Item_Maquina" ("chapaItemId", "id_chapa_item_maquina", "itemId", "maquinaId", "ordem", "prazo", "status") SELECT "chapaItemId", "id_chapa_item_maquina", "itemId", "maquinaId", "ordem", "prazo", "status" FROM "Chapa_Item_Maquina";
