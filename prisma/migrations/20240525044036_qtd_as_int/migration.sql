/*
  ...
  - You are about to alter the column `quantidade_comprada` on the `Chapas` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Int`.
  - You are about to alter the column `quantidade_estoque` on the `Chapas` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Int`.
  - You are about to alter the column `quantidade_recebida` on the `Chapas` table. The data in that column could be lost. The data in that column will be cast from `Float` to `Int`.
