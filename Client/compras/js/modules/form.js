...
export function handleAddMeasureBtnClick() {
    ...
    const quantasVezes = parseInt(document.getElementById("quantasvezes").value); // Captura o valor de quantasvezes
    const quantidade = parseInt(document.getElementById("quantidade").value); // Captura o valor de quantidade
    ...
    unconfirmedStagedCards.forEach(stagedCardContainer => {
        ...
        for (let i = 0; i < quantasVezes; i++) {
            ...
            removeButton.addEventListener("click", () => {
                stagedCard.remove(); // Remove o cardinconjug ao clicar no botão
            });
            ...
            // Cria o JSON com largura, comprimento, quantidade, quantas vezes, ID do stagedCard e ID do cardinconjug
            const medidaConjug = {
                id: cardinconjugId,
                largura: largura,
